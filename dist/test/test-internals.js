...
describe("truthy and falsy", () => {
    it("truthy", () => {
        isFalse((0, internals_1.isTruthy)(undefined));
        isFalse((0, internals_1.isTruthy)(null));
        isFalse((0, internals_1.isTruthy)(false));
        isTrue((0, internals_1.isTruthy)(true));
        isFalse((0, internals_1.isTruthy)([]), "empty array");
        isTrue((0, internals_1.isTruthy)(["foo"]), "non-empty array");
        isFalse((0, internals_1.isTruthy)({}), "empty object");
        isTrue((0, internals_1.isTruthy)({ foo: "bar" }), "non-empty object");
        isTrue((0, internals_1.isTruthy)("foo"));
        isFalse((0, internals_1.isTruthy)(""));
        isTrue((0, internals_1.isTruthy)(42));
        isFalse((0, internals_1.isTruthy)(0));
    });
    it("falsy", () => {
        isFalse((0, internals_1.isFalsy)(undefined));
        isTrue((0, internals_1.isFalsy)(null));
        isTrue((0, internals_1.isFalsy)(false));
        isFalse((0, internals_1.isFalsy)(true));
        isTrue((0, internals_1.isFalsy)([]), "empty array");
        isFalse((0, internals_1.isFalsy)(["foo"]), "non-empty array");
        isTrue((0, internals_1.isFalsy)({}), "empty object");
        isFalse((0, internals_1.isFalsy)({ foo: "bar" }), "non-empty object");
        isFalse((0, internals_1.isFalsy)("foo"));
        isTrue((0, internals_1.isFalsy)(""));
        isFalse((0, internals_1.isFalsy)(42));
        isTrue((0, internals_1.isFalsy)(0));
    });
});
describe("parsing of dates/date-times", () => {
    const check = (dateTimeLike, expected, message) => {
        equal((0, internals_1.dateFromString)(dateTimeLike).toISOString(), expected, message);
    };
...
describe("plusTime", () => {
    const check = (dateTimeLike, amount, unit, expected) => {
        equal((0, internals_1.plusTime)(dateTimeLike, amount, unit).toISOString(), expected);
    };
    ...
    it("yields comparable values", () => {
        isFalse((0, internals_1.plusTime)("2020-12-24", 0, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", -180, "day"), "d1 more than 180 days before d2");
        isFalse((0, internals_1.plusTime)("2020-12-24", 180, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", 0, "day"), "d1 more than 180 days before d2");
        isTrue((0, internals_1.plusTime)("2020-12-25", 0, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", -180, "day"), "d1 exactly 180 days before d2");
        isTrue((0, internals_1.plusTime)("2020-12-25", 180, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", 0, "day"), "d1 exactly 180 days before d2");
        isTrue((0, internals_1.plusTime)("2020-12-26", 0, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", -180, "day"), "d1 less than 180 days before d2");
        isTrue((0, internals_1.plusTime)("2020-12-26", 180, "day") >= (0, internals_1.plusTime)("2021-06-23T00:00:00Z", 0, "day"), "d1 less than 180 days before d2");
    });
...
describe("extractFromUVCI", () => {
    it("returns null on null operand", () => {
        equal((0, internals_1.extractFromUVCI)(null, -1), null);
        equal((0, internals_1.extractFromUVCI)(null, 0), null);
        equal((0, internals_1.extractFromUVCI)(null, 1), null);
    });
    it("works correctly on an empty string", () => {
        equal((0, internals_1.extractFromUVCI)("", -1), null);
        equal((0, internals_1.extractFromUVCI)("", 0), "");
        equal((0, internals_1.extractFromUVCI)("", 1), null);
    });
    it("foo/bar::baz#999lizards (without optional prefix)", () => {
        const uvci = "foo/bar::baz#999lizards";
        equal((0, internals_1.extractFromUVCI)(uvci, -1), null);
        equal((0, internals_1.extractFromUVCI)(uvci, 0), "foo");
        equal((0, internals_1.extractFromUVCI)(uvci, 1), "bar");
        equal((0, internals_1.extractFromUVCI)(uvci, 2), ""); // not null, but still falsy
        equal((0, internals_1.extractFromUVCI)(uvci, 3), "baz");
        equal((0, internals_1.extractFromUVCI)(uvci, 4), "999lizards");
        equal((0, internals_1.extractFromUVCI)(uvci, 5), null);
    });
    ...
    it("each separator adds a fragment", () => {
        const uvci = "a::c/#/f";
        equal((0, internals_1.extractFromUVCI)(uvci, 0), "a");
        equal((0, internals_1.extractFromUVCI)(uvci, 1), "");
        equal((0, internals_1.extractFromUVCI)(uvci, 2), "c");
        equal((0, internals_1.extractFromUVCI)(uvci, 3), "");
        equal((0, internals_1.extractFromUVCI)(uvci, 4), "");
        equal((0, internals_1.extractFromUVCI)(uvci, 5), "f");
    });
});
